...
// Inisialisasi variabel harga dengan nilai default
$harga = '';

if ($row) {
    // Cek apakah data ditemukan sebelum mengakses offset array
...
<body>
    ...
    <form action="" method="post" name='edit'>
        <center>
            <div class="col-sm-4">
                <label>Harga:</label>
                <input class="form-control form-control-sm" type="text" value="<?php echo $harga; ?>" aria-label=".form-control-sm example" name='mahar'>
            </div>
